...
class BaseCharacter {
  ...
  getHurt(damage) {
    ...
    var _this = this; // 慣例寫法 => 暫存 this 的變數
    var i = 1;
  ...
  updateHTML(hpElement, hurtElement) {
    ...
    hurtElement.style.width = (1 - this.hp / this.maxHp) * 100 + "%";
  }
}
...
class Hero extends BaseCharacter {
  ...
  attack(enemy) {
    ...
    super.attack(enemy, Math.floor(damage));
  }
...
var monster = new Monster("Skeleton", 150, 25);
